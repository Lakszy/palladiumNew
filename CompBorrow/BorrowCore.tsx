...
import { Repay } from "@/app/trove/Repay";
import { CloseTrove } from "@/app/trove/Close";
import { OpenTrove } from "@/app/trove/OpenTrove";
                              ...
                              <div className="grid w-full  space-y-7  max-w-sm items-start gap-2 mx-auto p-7  md:p-5">
                                ...
                                <div className="relative ">
                                  ...
                                  <button
                                    ...
                                    className={`mt-9 md:-ml-0 -ml-10 w-[19rem] rounded-3xl md:w-full title-text h-[3rem]
