                    ...
                    <h1 className="text-white text-sm ">
                      <div className="flex flex-row md:gap-x-0 gap-x-28 items-center justify-between">
                        <div className="text-white flex flex-col mt-05">
                          ...
                          <span className="body-text text-right">{Number(entireDebtAndColl.debt)} PUSD</span>
                        </div>
                        <div className="text-white flex flex-col mt-05">
                          <div className="flex items-center gap-x-1">
                          ...
                          <span className="body-text text-right whitespace-nowrap">{Number(entireDebtAndColl.coll).toFixed(4)} BTC</span>
                        </div>
                      </div>
                    </h1>
                  </div>
                    ...
                    <div>
                      ...
                      <div className="text-white p-2 flex flex-row justify-between mx-[2.5rem]">
                        ...
                        <div className="flex flex-col">
                          ...
                          <span className="text-xs body-text text-gray-500">${price.toFixed(4)}</span>
                        </div>
                        <div className="flex  flex-col">
                          {" "}
                          <span className="body-text text-gray-500">Debt</span>
                          <span className="body-text">{entireDebtAndColl.debt} PUSD</span>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="text-white ml-3">
                      ...
                      <div className="flex flex-row gap-10">
                        <div className="flex flex-col">
                          ...
                          <span className="body-text">{lr} PUSD</span>
                        </div>
