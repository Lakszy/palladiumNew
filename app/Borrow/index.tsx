...
const Borrow = () => {
  ...
  const [newUserDebt, setUserDebt] = useState("0")
  ...
  useEffect(() => {
    ...
    const fetchedData = async () => {
      ...
      const one = await troveManagerContract.getEntireSystemColl()
      const two = await troveManagerContract.getEntireSystemDebt()

      console.log(one, two, "I am new")
  ...
  const makeCalculations = async (xBorrow: string, xCollatoral: string) => {
    ...
    const totalColl = (collFormatted + collValue) * Number(fetchedPrice); // multiply it by price

    const userColl = (collValue) * Number(fetchedPrice); // multiply it by price
  ...
  const handlePercentageClick = (percentage: any) => {
    ...
    if (!isNaN(pusdBalanceNumber)) {
      ...
      console.log(stakeFixed, 'llalalalalalala')
  ...
  const handlePercentageClickBTC = (percentage: any) => {
    ...
    // Log the formatted number from balanceData?.formatted
              ...
              <div className=" flex flex-col md:flex-row gap-10" style={{ backgroundColor: "#2b2924" }}>
                <div className="p-2">
                  ...
                  <div className="flex flex-row justify-between mt-5 gap-4">
                    ...
                    <div
                      className="flex flex-col text-white w-[9rem]  h-28 p-5"
                      style={{ backgroundColor: "#343127" }}
                    >
                ...
                <div
                  className="md:w-[14rem]  md:h-[13rem] mt-4"
                  style={{ backgroundColor: "#343127" }}
                >
                ...
                <div
                  className="md:w-[25rem] h-[13rem] mt-3 px-8 py-4"
                  style={{ backgroundColor: "#343127" }}
                >
                                ...
                                <div className="relative">
                                  ...
                                  >
                                    ...
                                    <input
                                      ...
                                      className="body-text text-sm whitespace-nowrap ml-1 h-[4rem] text-white"
                                      style={{ backgroundColor: "#3f3b2d" }}
                                    />
                                    <span
                                      className="w-8 text-white body-text text-xs whitespace-nowrap mr-3"
                                      style={{ backgroundColor: "#3f3b2d" }}
                                    >
                                ...
                                <div className="relative">
                                  ...
                                  >
                                    ...
                                    <input
                                      ...
                                      className="w-[23.75rem] ml-1 h-[4rem] body-text text-sm whitespace-nowrap text-white"
                                      style={{ backgroundColor: "#3f3b2d" }}
                                    />
                                  </div>
                                  <div className="flex flex-col  md:flex-row gap-x-5  justify-between">
                                    <span className="text-white gap-x-2 flex md:flex-row  md:w-full w-20 flex-col">
                                      ...
                                      <h6 className="body-text mt-5 text-sm">
                                  ...
                                  <button onClick={() => handleConfirmClick(userInputs.borrow, userInputs.depositCollateral)} className="mt-5 md:w-full w-[20rem] md:-ml-0 -ml-3 h-[3rem] bg-yellow-300 title-text text-black">  UPDATE TROVE</button>
                                </div>
                              </div>
                            </div>
                            <div className="w-auto p-10 border  md:mt-10 text-sm"
                              ...
                              <div className="mb-4 space-y-4">
                                ...
                                <div className="flex md:gap-40 text-white mb-2 justify-between">
                                  ...
                                  <span className="text-xs whitespace-nowrap body-text">{Number(value).toFixed(2)} %</span>
                                </div>

                                <div className="flex md:gap-40 text-white mb-2 justify-between">
                                  <span className="body-text text-xs whitespace-nowrap">Liq. Reserve</span>

                                  <span className="text-xs whitespace-nowrap body-text">{Number(lr).toFixed(2)} PUSD</span>
                                </div>
                              ...
                              <div className=" space-y-4">
                                <div className="flex md:gap-40 body-text text-white mb-2 justify-between">
                                  <span className="body-text text-xs whitespace-nowrap">Loan-To-Value</span>
                                ...
                                <div className="flex gap-20 text-white mb-2 body-text justify-between">
                                  <span className="body-text body-text text-xs whitespace-nowrap">Liquidation </span>
                                ...
                                <div className="flex md:gap-40 body-text text-white mb-2 justify-between">
                                  ...
                                  <span className="body-text text-xs whitespace-nowrap">
                                    {Number(newUserColl).toFixed(4)} BTC
                                  </span>
                                </div>
              ...
              <div className="pt-10 p-5 h-screen">
                <div className=" border border-black shadow-lg w-full" style={{ backgroundColor: "#3f3b2d" }}>
                  <div className="flex flex-row m-1  gap-x-12">
                    ...
                    <div className=" h-fit space-y-20">
                      <div>
                        <h6 className="text-white  text-center text-3xl title-text  ">
                ...
                <div className="container pt-2 body-text flex flex-row justify-between">
                  <div>
                    <div className="grid w-full max-w-sm items-start gap-2 mx-auto   p-5">
                      <div className="">
                        <Label htmlFor="items" className="body-text text-gray-500  body-text ">
                          Deposit Collatoral
                        </Label>
                        <div
