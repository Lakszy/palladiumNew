              ...
              <div className="p-2">
                ...
                <div className="flex flex-row justify-between mt-5 gap-4">
                  <div className="flex flex-col text-white  h-28 p-5" style={{ backgroundColor: "#343127" }}>
                    ...
                    <span className="body-text text-sm p-1 text-gray-500">${(Number(fetchedPrice) * Number(entireDebtAndColl.coll)).toFixed(2)}</span>
                  </div>
                                  ...
                                  <div className="flex items-center gap-x-3">
                                    ...
                                    <>
                                      {userInputColl == 1 && (
                                        <>
                                          {`--->`}
                                          <span className="ml-05">{" "}{Number(newUserColl).toFixed(8)} BTC</span>
                                        </>
                                      )}
                                    </>
                                  </div>
