        ...
        <div className="md:h-screen " style={{ backgroundColor: '#272315' }}>
          ...
          <div className="flex md:flex-row flex-col mt-12 md:mt-28 justify-between">
            ...
            <div className="md:-mt-7 w-1/2 p-6">
              <h1 className="text-lg font-semibold font-sans text-yellow-300 title-text">About Redemptions</h1>
              <div className="text-gray-400 md:w-full w-screen text-sm body-text leading-normal mt-2">
