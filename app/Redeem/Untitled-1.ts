...
//     const [redeemGasFee, setRedeemGasFee] = useState<string | null>(null);
...
//         fetchData();
//     }, []);
//     console.log(redeemGasFee,setRedeemGasFee,"laksh G")

//     useEffect(() => {
//         const estimateGasFees = async () => {
//             if (!provider || !feeData?.gasPrice) return;
...
//                 const gasEstimate = await neTrove.redeemCollateral(
//                     truncatedLUSDAmount,
//                     firstRedemptionHint,
//                     firstRedemptionHint,
//                     firstRedemptionHint,
...
//                 setRedeemGasFee(gasEstimate.mul(feeData.gasPrice).toString());
//             } catch (error) {
...
//         estimateGasFees();
//     }, [userInput, feeData, provider, neTrove, priceFeedContract]);
...
//                         </span>
//                         {redeemGasFee && (
//                             <div className="mt-2 body-text text-yellow-300">
//                                 Estimated Gas Fee for Redemption: {ethers.formatUnits(redeemGasFee, 'ether')} ETH
//                             </div>
//                         )}
//                     </div>
