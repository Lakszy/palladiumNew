            ...
            <div className="p-5">
              ...
              {(transactionRejected || (!isSuccess && showCloseButton)) && (
                <>
                  ...
                  <Button className=" mt-1 p-3 rounded-none w-[20rem] text-black title-text2 hover:bg-yellow-400 hover:scale-95 bg-[#f5d64e]" onClick={handleClose}>Try again</Button>
                </>
              )}
            </div>
          </div>
