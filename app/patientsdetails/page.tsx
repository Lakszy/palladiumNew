                ...
                <div className='p-4 '>
                    ...
                    <div className='flex justify-between'>
                        <div className='flex items-center gap-x-2'>
                            ...
                            <h1 className="text-zinc-800 text-xl font-bold  leading-7">Patient Details</h1>
                        </div>
                        <div className="w-[130px] h-[55px] px-[21px] py-[3px] bg-blue-700 bg-opacity-10 rounded-[30px] border border-blue-700 justify-start items-center gap-2 inline-flex">
                            <div className="justify-start items-center gap-2 flex">
                                ...
                                <div className="text-blue-700 text-lg font-semibold leading-loose">Export</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="w-full pt-4 rounded-lg inline-flex justify-between px-2">
                        <div className='gap-x-4 flex'>
                            <Image alt='patient' className="w-[247px] h-[233px] rounded-[10px]" src={patient} />
                            <div>
                                <div>
                                    <div className="text-zinc-800 text-2xl font-bold whitespace-nowrap">Dheeraj Pandey</div>
                                    <div className="text-zinc-800 text-opacity-70 text-xl font-medium whitespace-nowrap">Noida, Uttar Pradesh</div>
                                </div>
                                <div className="justify-start pt-2 pb-2 items-start gap-x-3 flex">
                                    <div className="px-5 w-[147px] bg-lime-600 bg-opacity-10 rounded-[30px] justify-center items-center gap-2.5 flex">
                                        <div className="text-lime-600 text-xl font-medium leading-loose whitespace-nowrap">Sore throat</div>
                                    </div>
                                    <div className="px-5 bg-blue-700 bg-opacity-10 rounded-[30px] justify-center items-center gap-2.5 flex">
                                        <div className="text-blue-700 text-xl font-medium leading-loose whitespace-nowrap">Male</div>
                                    </div>
                                    <div className="px-5 bg-pink-600 bg-opacity-10 rounded-[30px] justify-center items-center gap-2.5 flex">
                                        <div className="text-pink-600 text-xl font-medium leading-loose whitespace-nowrap">42 Yr</div>
                                    </div>
                                </div>
                                <div className='flex items-center gap-x-2 '>
                        ...
                        <div className="flex-col rounded-2xl justify-start items-center gap-2.5 inline-flex bg-blue-200">
                            ...
                            <div className="text-zinc-800 text-base font-bold  leading-loose">Recommend Prescriptions</div>
                            <div className="text-center text-zinc-800 text-opacity-70 text-xs font-medium  leading-none">Treat your patient in a effectively and <br />professional way</div>
                            <div className="mx-2 my-2 w-[222px] h-[42px] px-[63px] py-[15px] bg-slate-800 rounded-md justify-start items-center gap-2.5 inline-flex">
                                <div className="text-white text-base font-semibold leading-loose">Recommend</div>
                            </div>
                        </div>
                    </div>
                    <div className="w-full mt-2 pl-4 pr-[781px] py-4 bg-stone-100 rounded-[22px] justify-start items-center gap-3 inline-flex">
                        <Image alt='ladyPatient' className="w-[108px] h-[105px] rounded-xl" src={lady} />
                        <div className="flex-col justify-start items-start inline-flex">
                            <div className="text-zinc-800 text-2xl font-bold">Dr. Anisha Mehta</div>
                            <div className="text-zinc-800 text-opacity-70 text-xl font-base">Otolaryngologist</div>
                        </div>
                    </div>
                </div>
            </div>
