    ...
    return (
        <>
            <div className="p-4 ">
                ...
                <div className="w-full ml-2 justify-between px-2 border-gray-200 rounded-3xl  bg-white border-2 h-[177px] items-center gap-3 inline-flex">
                ...
                <div className="w-full mt-5  whitespace-nowrap inline-flex gap-3 gap-x-4 ml-3">
                ...
                <div className="grid grid-cols-[65%_35%] h-fit mt-2 gap-x-4 pr-10 ">
                    <div className="border-2 rounded-lg ">
                        ...
                        <div className="w-full  py-[22px] bg-green-500 bg-opacity-20 rounded-[22px] flex-col justify-start items-start gap-2.5 inline-flex mt-3">
                            <div className="flex-col justify-start items-start gap-5 flex px-10">
                        ...
                        <div className="w-full -translate-x-2 translate-x-2 py-[22px] bg-green-500 bg-opacity-20 rounded-[22px] flex-col justify-start items-start gap-2.5 inline-flex mt-3">
                            <div className="flex-col justify-start items-start gap-5 flex px-10">
                                <div className="text-zinc-800 text-xl font-bold  leading-7">Complaints</div>
                                <div className="flex-col justify-start items-start gap-[26px] flex">
                                    <div className="w-[659px] h-[13px] relative">
                    ...
                    <div className="border-2 pl-5 pt-3 bg-white rounded-lg overflow-y-auto pr-10">
                        <div className="w-full h-[49px] px-[62px] py-5 bg-emerald-100 rounded-xl justify-center items-center gap-2.5 inline-flex">
                            <div className="text-zinc-800 text-md font-bold ">Suggestive Medications</div>
                        </div>
                        <div className="border-2 w-full flex-col justify-start items-start gap-2.5 inline-flex p-2 m-2 bg-gray-100 rounded-xl">
