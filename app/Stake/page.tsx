      ...
      <div className="body text-black  overflow-y-scroll ">
        ...
        <div className="md:h-screen " style={{ backgroundColor: '#272315' }}>
          <div className="text-center">
            <h1 className="text-4xl pt-10 font-semibold w-[23rem] ml-[7%] md:ml-0 text-center md:w-full text-yellow-300 title-text">Earn By Supplying PUSD to Stability Pool</h1>
          </div>
