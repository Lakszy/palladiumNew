      ...
      <div className="body text-black  overflow-y-scroll ">
        ...
        <div className="md:h-screen " style={{ backgroundColor: 'black' }}>
          <div className="text-center">
            <h1 className="text-2xl  md:w-full w-[24rem] pt-12 font-medium text-white title-text2">Exchange 1 ORE For $1 Worth Of BTC</h1>
          </div>
          <div className="flex md:flex-row flex-col mt-12 md:mt-28 justify-between">
            ...
            <div className="md:-mt-7 w-[40%] p-6 mr-16">
              ...
              <div className="text-gray-400 w-72 md:w-full text-sm body-text leading-normal">
                Redemptions are one of Palladium’s most unique and important title-text protocol features. The redemption mechanism gives ORE holders the ability to redeem the underlying BTC collateral at face value at any time.
