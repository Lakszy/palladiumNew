...
const ThreeTroveCard = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                const protocolMetricsBTC = data[0].metrics[0]; // Fetch the metrics for earthBTC (at index 0)
    ...
    return (
        <div className='p-5 h-scree w-full' style={{ backgroundColor: "black" }}>
            ...
            <div className='flex md:flex-row flex-col md:pl-5 pt-5 pb-5 w-1/2 justify-between items-center'>
                <div className={`bg-[#222222] md:w-1/2 rounded-lg text-white w-full md:p-6 md:mb-0 mb-3 p-3  flex-1 mx-2 ${troveStatusBTC === "ACTIVE" ? "space-y-3 md:h-[38rem]" : "space-y-16"}`}>
                        ...
                        <>
                            ...
                            <div className='p-3 grid grid-cols-3 space-y-8  items-center justify-around'>
                                <div className="text-left mt-1">
                                    ...
                                    <p className="body-text font-medium mt-">{Number(entireDebtAndCollBTC.collBTC).toFixed(8)} earthBTC</p>
                    ...
                    <div className={`${troveStatusBTC === "ACTIVE" ? "py-10" : "py-5"}`}>
                        <>
                            <div className={`border-t border-gray-400 mb-6 md:-ml-[1.5rem] md:w-[108.5%] ${troveStatusBTC === 'ACTIVE' ? '-m-4' : ''}`}></div>
                            {isConnected ? (<>
