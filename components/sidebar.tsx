  ...
  return (
    ...
    >
      <div className="flex items-center gap-x-1 justify-center">
        <Link href="/">
          <Image
            src={logo}
            alt="Logo"
            className="mr-12 top-5 fixed absolute left-10 w-40"
          />
        </Link>
      </div>
      <nav className="flex flex-col gap-y-2 px-4">
        <Link href="/">
          <div
            className={` hover:scale-95 cursor-pointer text-xl menu flex min-w-[200px] items-center gap-x-3 rounded-lg p-2 ${
              isRoute("/")
                ? "bg-yellow-400 rounded-none text-black"
                : "text-gray-500"
            }`}
          >
            <div
        ...
        <Link href="/portfolio">
          <div
            className={`cursor-pointer  hover:scale-95 text-xl menu flex min-w-[200px] items-center gap-x-3 rounded-lg p-2 ${
              isRoute("/portfolio")
                ? "bg-yellow-400 rounded-none text-black"
                : "text-gray-500"
            }`}
          >
            <div
              className={`cursor-pointer menu flex items-center gap-x-3 rounded-full p-2 ${
                isRoute("/portfolio") ? "text-black" : " text-white"
              }`}
            >
        ...
        <Link href="/trove">
          ...
          >
            <div
              className={`cursor-pointer menu flex items-center gap-x-3 rounded-full p-2 ${
                isRoute("/trove") ? "text-black" : " text-white"
              }`}
            >
        ...
        <Link href="/Stake">
          ...
          >
            <div
              className={`cursor-pointer menu flex items-center gap-x-3 rounded-full p-2 ${
                isRoute("/stake") ? "text-black" : " text-white"
              }`}
            >
        ...
        <Link href="/redeem">
          ...
          >
            <div
              className={`cursor-pointer menu flex items-center gap-x-3 rounded-full p-2 ${
                isRoute("/redeem") ? "text-black" : " text-white"
              }`}
            >
      ...
      <div className="space-y-1 h-16">
        ...
        <div className="flex items-center justify-center text-white gap-x-5  text-[19px] ">
          <Link target="_blank" href="https://twitter.com/PalladiumLabs">
            {" "}
            <Image className="hover:scale-105" src={tweet} alt="twitter" />
          </Link>
          <Link target="_blank" href="https://discord.com/invite/9MMEyJ4JDz">
            {" "}
            <Image className="hover:scale-105" src={discord} alt="twitter" />
          </Link>
          <Link target="_blank" href="https://medium.com/palladium-labs">
            {" "}
            <Image className="hover:scale-105" src={medium} alt="twitter" />
          </Link>
        </div>
      </div>
    </div>
