...
const StatsCard: React.FC<{ value: number; label: string; color: string; icon: React.ElementType }> = ({ value, label, color, icon: Icon }) => (
  <div className={`flex flex-col gap-y-1 p-2 bg-white rounded-2xl items-center justify-center h-full border-2 border-gray-400`}>
...
export const CenterBar: React.FC = () => (
  <div className="grid grid-cols-[1fr_max-content]">
    <div className="bg-green-50 border-2 border-green-400  rounded-lg"></div>
    <div className="grid h-fit p-2 gap-y-2 ">
      <div className="bg-white border-gray-400 h-full rounded-md border-2 flex items-center ">
      ...
      <div className="grid grid-flow-col w-stretch h-48 gap-2 items-stretch">
